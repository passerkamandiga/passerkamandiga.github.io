...
<html lang="en">
	<head>
		...
		<link href="dist/css/styles.css?v=1.2" rel="stylesheet">
		<link href="dist/css/queries.css?v=1.2" rel="stylesheet">
		<link rel="stylesheet" href="dist/css/flexslider.css?v=1.2" type="text/css">
	...
	<body>
		<header>
					...
					<div class="col-md-7 col-md-offset-3">
						<nav>
							...
							<ul class="clearfix">
								...
								<li class="dot">.</li>
								<li><a href="#Profil" class="r_spacer">Profil</a></li>
			...
			<div class="Untitled-1"></div>
		</header>
		<div class="container-fluid intro" id="Profil">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<h1 class="chain">Profil Organisasi</h1>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-8 section-1 nopadding" id="Galeri">
					<div class="logo-1 wp1"></div>
				</div>
				<div class="col-md-4 section-text nopadding">
					<div class="wp4">
						<h2 class="frame">Galeri</h2>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-4 section-text nopadding">
					<div class="wp6">
						<h2 class="front-frame">Galeri</h2>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived.</p>
						<div class="thin-sep"></div>
					</div>
		...
		<section id="contact" class="home-section bg-white">
	  	<div class="container">
	  		...
	  		<div class="row">
				...
				<form action="MAILTO:someone@example.com" method="post" enctype="text/plain" class="form-horizontal" role="form">
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <input type="text" class="form-control" id="inputName" name="name" placeholder="Name" value="your name">
					</div>
				  </div>
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <input type="email" class="form-control" id="inputEmail" name="mail" placeholder="Email" value="your email">
					</div>
				  </div>
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
				  ...
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <textarea name="message" class="form-control" rows="3"  name="Message" placeholder="Message" value="your comment"></textarea>
					</div>
				  </div>
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					 <input type="submit" class="btn btn-theme btn-lg btn-block" value="Send">Send message</button>
					</div>
				  </div>
				</form>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 footer-rightcol">
						<p>Designed by <a href="#"><img src="dist/img/yebo-icon.png" alt="Yebo Logo"></a></p>
